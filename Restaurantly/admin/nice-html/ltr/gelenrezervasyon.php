            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Gelen Rezervasyonlar</h4>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Gelen Rezervasyonlar</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">TARİH</th>
                                            <th class="border-top-0">ZAMAN</th>
                                            <th class="border-top-0">KİSİ SAYISI</th>
                                            <th class="border-top-0">SİPARİŞ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                 ...
                                 while($row=mysqli_fetch_array($bilgiler))
                                {
                                 ...
                                 echo "<td>".$telefonNo."</td>";
                               
                                 echo "<td>".$tarih."</td>";
                               
                                 echo "<td>".$zaman."</td>";
                             
                                 echo "<td>".$kisiSayisi."</td>";
                                 ...
                                 echo "</tbody>";
                                      ...
                                      <!--      <td class="txt-oflo">Elite admin</td>
                                            ...
                                            <td><span class="txt-oflo">12.12.2020</span></td>
                                            <td><span class="font-medium">20.20</span></td>
                                            <td><span class="txt-oflo">5</span></td>
