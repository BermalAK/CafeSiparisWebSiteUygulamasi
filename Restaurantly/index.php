...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.php">BERNİS Cafe</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="book-a-table text-center"><a  data-toggle="modal" data-target="#exampleModal">Admin Girişi</a></li>
        </ul>
      </nav><!-- .nav-menu -->
      ...
      <div class="modal-body">
        <form action="uyegiris.php" method="post">
          <div class="form-group">
            <label style="color:black;"> <b>Kullanıcı Adı</b> </label>
            <input type="text" class="form-control" name="kAdi">
          </div>
          <div class="form-group">
            <label style="color:black;"> <b>Şifre</b> </label>
            <input type="password" class="form-control"  name="sifre"></input>
          </div>
  ...
  mysqli_set_charset($aVar,"utf8");
                ...
                {
                    $baslık=$row['YemekAdi'];
                    $icerik=$row['YemekTarif'];
                    $foto=$row['YemekImg'];
                    $durum=$row['durum'];
                    $fiyat=$row['fiyat'];
                if($durum=="filter-starters")
                    {  
                        echo '<div class="col-lg-6 menu-item filter-starters">'; 
                        echo "<img src=".$foto." class='menu-img'>";
                        echo ' <div class="menu-content">';
                        echo "<a href='#'>".$baslık."</a><span>".$fiyat."</span>";
                        echo ' </div><div class="menu-ingredients">';
                        echo "<p>".$icerik."</p>";
                        echo '</div>';
                        echo '</div>'; 
                    }
                    elseif($durum=="filter-salads")
                    {
    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form action="rezervasyon.php" method="post" role="form" data-aos="fade-up" data-aos-delay="100">
          <div class="form-row">
            ...
            <div class="col-lg-4 col-md-6 form-group">
              <input type="date" name="date" class="form-control" id="date" placeholder="Tarih" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            <div class="col-lg-4 col-md-6 form-group">
              <input type="time" class="form-control" name="time" id="time" placeholder="Zaman" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            <div class="col-lg-4 col-md-6 form-group">
          ...
          <div class="text-center"><button class="btn btn-dark" type="submit">Siparişleri Kaydet</button></div>
        </form>
...
<div class="col-lg-4 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/resized_esraf1.jpg" class="venobox" data-gall="gallery-item">
                <img   src="assets/img/gallery/resized_esraf1.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/a.jpg" class="venobox" data-gall="gallery-item">
          ...
          <div class="col-lg-4 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/b.jpg" class="venobox" data-gall="gallery-item">
          ...
          <div class="col-lg-4 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/resized_esraf4.jpg" class="venobox" data-gall="gallery-item">
                <img   src="assets/img/gallery/resized_esraf4.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/aa.jpg" class="venobox" data-gall="gallery-item">
                <img   src="assets/img/gallery/aa.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
           ...
           <div class="col-lg-4 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/c.jpg" class="venobox" data-gall="gallery-item">
  ...
  mysqli_set_charset($aVar,"utf8");
                ...
                echo "<i class='icofont-google-map'></i>";
                echo "<p>".$baslık."</p>";
                echo "<div class='open-hours'>";
                echo "<i class='icofont-clock-time icofont-rotate-90'></i>";
                echo "<p>".$icerik."</p>";
                echo "<div class='email'>";
                echo "<i class='icofont-envelope'></i>";
                echo "<p>".$email."</p>";
                echo " <div class='phone'>";
                echo "<i class='icofont-phone'></i>";
                echo "<p>".$telefon."</p>";
                echo '</div>';
                echo '</div>';
                echo '</div>';
          ...
          <div style="margin-top: 40px;" class="container";>
            ...
            <form action="iletigönder.php" method="POST" role="form">
              <div class="form-row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control" id="isim" placeholder="İsminiz" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                  <div class="validate"></div>
                </div>
                <div class="col-md-6 form-group">
                  <input type="email" class="form-control" name="email" id="mail" placeholder="Mail Adresiniz" data-rule="email" data-msg="Please enter a valid email" />
                  <div class="validate"></div>
                </div>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" name="subject" id="konu" placeholder="Konu" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
              ...
              <div class="text-center"><button class="btn btn-dark" type="submit">Mesaj Gönder</button></div>
            </form> 
